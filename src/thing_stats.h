...
long compute_creature_max_pay(long base_pay,unsigned short crlevel, struct Thing* thing);
...
long compute_creature_max_training_cost(long base_training_cost,unsigned short crlevel, struct Thing* thing);
long compute_creature_max_scavenging_cost(long base_scavenging_cost,unsigned short crlevel, struct Thing* thing);
